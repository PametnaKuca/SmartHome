 ...
 *            - > 0: Button is pressed
 */
 #define TM_DISCO_ButtonPressed()       ((TM_GPIO_GetInputPinValue(GPIOA, BUTTONPIN) == 1) == TM_DISCO_BUTTON_PRESSED)

#define TM_DISCO_Reset_Button()				 ((TM_GPIO_SetPinValue(TM_DISCO_BUTTON_PORT, TM_DISCO_BUTTON_PIN,0)))
/**
